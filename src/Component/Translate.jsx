    ...
    <div className="container">
        <div className="wrapper">
            <div className="text-input">
             <textarea spellCheck="false" className='from-text' placeholder='Enter text' value={fromText} onChange={(e)=>setfromText(e.target.value)}></textarea>

            <textarea readOnly spellCheck="false"  className='to-text' placeholder='Translation' value={toText}></textarea>
            </div>
